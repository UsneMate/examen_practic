...
function Comptar() {
  const fraseComptar = document.getElementById("cadena").value.trim().toLowerCase(); // ID correcte
  ...
  const arrayParaules = fraseComptar.split(" ").filter(p => p.trim() !== ""); // Elimina paraules buides
